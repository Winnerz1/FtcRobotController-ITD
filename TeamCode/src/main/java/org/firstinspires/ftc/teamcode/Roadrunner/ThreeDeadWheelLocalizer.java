...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -13602.553941316526; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 14421.141130129012; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -10984.03850533126; // x position of the perpendicular encoder (in tick units)
    }
